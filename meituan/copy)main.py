...
class MeituanSpider(object):
    ...
    def get_content(self, city_code='chs'):
    ...
    def get_sign(self, city_name):
        sign_dict = {
            ...
            'dinnerCountAttrId': '',
            'optimusCode': 10,
            'originUrl': "https://chs.meituan.com/meishi/pn{}&page={}&partner=126&platform=1&riskLevel=1&sort=&userId=&uuid={}".format(self.current_page,self.current_page,self.get_uuid()),
